...
parseNamedTypingRule abbrevs =
  ...
  (do str_ "el-quot-elim-cong"; space; (ctx, env) <- parseNamedCtx abbrevs; sp; str_ "⊦"; sp
  ...
  (do str_ "el-quot-ty"; space; (ctx, env) <- parseNamedCtx abbrevs; sp; str_ "⊦"; sp; e <- parseElem env
      sp; char_ ':'; sp; str_ "𝕌"
      case e of
