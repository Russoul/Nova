module Nova.Kernel.Dormant.Tests

-- The dormant derivation artifact's directly-wired test cases: 23
-- hard-coded candidate derivations run through concludeItem by the
-- nova-tests "deriv" mode (the tests/nova/derivation/deriv-core
-- golden invokes it). Lives with the artifact so every implementation
-- file of it is under Nova/Kernel/Dormant (docs/NovaDerivations.txt).

import Data.List

import Nova.Kernel.Syntax
import Nova.Kernel
import Nova.Kernel.Dormant.Derivation
